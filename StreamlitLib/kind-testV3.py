...
#     buffer = BytesIO()
#     c = canvas.Canvas(buffer, pagesize=(80 * mm, 20 * mm))  # Receipt size in mm
...
#     c.drawString(10 * mm, 185 * mm, infos)

#     c.drawString(10 * mm, 180 * mm, transaction_date)

#     # Line separator
#     c.line(5 * mm, 175 * mm, 75 * mm, 175 * mm)

#     # Customer and server info
#     c.drawString(10 * mm, 170 * mm, "Servi par: mohammed - #1")
#     c.drawString(10 * mm, 165 * mm, "Client: mohammed - #2")

#     # Line separator
#     c.line(5 * mm, 160 * mm, 75 * mm, 160 * mm)
...
#         c.drawRightString(70 * mm, y_position * mm, f"{product_total:.2f} $")
#         y_position -= 10

#     # Line separator
#     c.line(5 * mm, (y_position + 5) * mm, 75 * mm, (y_position + 5) * mm)

#     # Total price
#     c.setFont("Courier-Bold", 10)
#     c.drawString(10 * mm, (y_position - 5) * mm, "TOTAL")
#     c.drawRightString(70 * mm, (y_position - 5) * mm, f"{total_price:.2f} $")

#     # Line separator
#     c.line(5 * mm, (y_position - 10) * mm, 75 * mm, (y_position - 10) * mm)
...
#         y_position -= 5
#         c.drawString(10 * mm, (y_position - 15) * mm, line)
#         y_position -= 5
